...
('Administrador General', 'admin@empresa.cl', SHA2('admin123', 256), 'ADMIN'),
('Camila Rojas', 'camila@empresa.cl', SHA2('usuario123', 256), 'USUARIO'),
('Diego Soto', 'diego@empresa.cl', SHA2('usuario123', 256), 'USUARIO'),
('Javiera Lagos', 'javiera@empresa.cl', SHA2('usuario123', 256), 'USUARIO');
